...
import { TRAER_TODAS, CARGANDO, ERROR, CAMBIO_USUARIO_ID , CAMBIO_TITULO, GUARDAR, ACTUALIZARIS, LIMPIAR } from '../types/tareastypes';
...
export const cambioCheck = (usu_id, tar_id) => (dispatch, getState) => {
    ...
    const selecionada = tareas[usu_id][tar_id];
    ...
    actualizadas[usu_id][tar_id] = {
        ...
        completed: !selecionada.completed
    }
